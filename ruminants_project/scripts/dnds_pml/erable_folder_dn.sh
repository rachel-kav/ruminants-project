...
OUTPUT_DIR="/Users/qjs599/Desktop/ruminants/ruminants_project/data/dn_erable_output_16.09"

# Create output directory if it doesn't exist
mkdir -p "$OUTPUT_DIR"

# Find and copy matching files
find "$BASE_DIR" -type f -name "*erable_dn_16.09.length.nwk" ! -path "$OUTPUT_DIR/*" | while read -r filepath; do
